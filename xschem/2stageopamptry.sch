...
C {devices/title.sym} 160 -40 0 0 {name=l4 author="vlsi"}
...
C {sky130_fd_pr/cap_mim_m3_2.sym} 960 -520 1 0 {name=C3 model=cap_mim_m3_2 W=39 L=39 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_2.sym} 1250 -400 0 0 {name=C1 model=cap_mim_m3_2 W=71 L=71 MF=1 spiceprefix=X}
