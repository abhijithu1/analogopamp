...
C {devices/title.sym} 160 -40 0 0 {name=l4 author="group"}
...
C {sky130_fd_pr/cap_mim_m3_2.sym} 1010 -520 1 0 {name=C3 model=cap_mim_m3_2 W=39 L=39 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_2.sym} 1250 -320 0 0 {name=C2 model=cap_mim_m3_2 W=71 L=71 MF=1 spiceprefix=X}
